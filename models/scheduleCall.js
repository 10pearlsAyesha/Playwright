...
class ScheduledPage {
  constructor(page) {
    ...
    this.startDateField = page.locator("(//div[@class='v-text-field__slot'])[2]");
    this.startTimeField = page.locator("(//div[@class='v-text-field__slot'])[3]");
    ...
    this.endDateField = page.locator("(//div[@class='v-text-field__slot'])[4]");
    this.endTimeField = page.locator("(//div[@class='v-text-field__slot'])[5]");
